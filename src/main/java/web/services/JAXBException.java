...
public class JAXBException  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    private web.services.StackTraceElement[] linkedException;
    ...
    public JAXBException(
           ...
           web.services.StackTraceElement[] linkedException,
     ...
     */
    public web.services.StackTraceElement[] getLinkedException() {
        return linkedException;
    }
     ...
     */
    public void setLinkedException(web.services.StackTraceElement[] linkedException) {
        this.linkedException = linkedException;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://services.web/", "JAXBException"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://services.web/", "stackTraceElement"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
